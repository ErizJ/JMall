...
-- Records of carousel
-- ----------------------------
INSERT INTO `carousel` VALUES (1, 'public/imgs/cms_1.jpg', '轮播图-1');
INSERT INTO `carousel` VALUES (2, 'public/imgs/cms_2.jpg', '轮播图-2');
INSERT INTO `carousel` VALUES (3, 'public/imgs/cms_3.jpg', '轮播图-3');
INSERT INTO `carousel` VALUES (4, 'public/imgs/cms_4.jpg', '轮播图-4');
...
CREATE TABLE `category`  (
  ...
  `category_hot` int NULL DEFAULT NULL COMMENT '用于大众推荐，对所有用户都生效',
...
-- Records of collect
-- ----------------------------
INSERT INTO `collect` VALUES (1, 1, 2, 1, 1648917267805);
INSERT INTO `collect` VALUES (5, 1, 35, 5, 1649071954823);
INSERT INTO `collect` VALUES (6, 1, 4, 1, 1649686600650);
INSERT INTO `collect` VALUES (8, 1, 10, 2, 1649697282335);
INSERT INTO `collect` VALUES (10, 1, 9, 2, 1650653138101);
INSERT INTO `collect` VALUES (11, 1, 14, 2, 1650653150984);
INSERT INTO `collect` VALUES (12, 1, 11, 2, 1650680187501);
INSERT INTO `collect` VALUES (13, 1, 1, 1, 1650683424895);
INSERT INTO `collect` VALUES (14, 1, 16, 3, 1650683805744);
INSERT INTO `collect` VALUES (15, 1, 36, 3, 1650683814322);

-- ----------------------------
-- Table structure for combination_product
-- ----------------------------
DROP TABLE IF EXISTS `combination_product`;
CREATE TABLE `combination_product`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `main_product_id` int NOT NULL COMMENT '满减需要达到的金额',
  `vice_product_id` int NOT NULL COMMENT '满减金额',
...
-- ----------------------------
-- Records of combination_product
-- ----------------------------
INSERT INTO `combination_product` VALUES (1, 1, 9, 2000, 200);
INSERT INTO `combination_product` VALUES (2, 2, 8, 3000, 300);
INSERT INTO `combination_product` VALUES (3, 3, 8, 3000, 300);
INSERT INTO `combination_product` VALUES (4, 10, 25, 2000, 200);
INSERT INTO `combination_product` VALUES (5, 6, 10, 3000, 300);
INSERT INTO `combination_product` VALUES (21, 2, 32, 2000, 200);
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (7, 11650560587394, 1, 12, 1, 1299, 1650560587394);
INSERT INTO `orders` VALUES (8, 11650560587394, 1, 14, 1, 2799, 1650560587394);
INSERT INTO `orders` VALUES (9, 11650560587394, 1, 31, 1, 69, 1650560587394);
INSERT INTO `orders` VALUES (10, 11650560587394, 1, 35, 1, 12.9, 1650560587394);
INSERT INTO `orders` VALUES (11, 11650560587394, 1, 1, 1, 1599, 1650560587394);
INSERT INTO `orders` VALUES (12, 11650560587394, 1, 10, 1, 1899, 1650560587394);
INSERT INTO `orders` VALUES (13, 11650560587394, 1, 9, 1, 799, 1650560587394);
INSERT INTO `orders` VALUES (14, 11650560587394, 1, 25, 1, 129, 1650560587394);
INSERT INTO `orders` VALUES (15, 21650640654586, 2, 31, 1, 69, 1650640654586);
INSERT INTO `orders` VALUES (16, 21650640654586, 2, 6, 1, 1199, 1650640654586);
INSERT INTO `orders` VALUES (17, 21650640654586, 2, 4, 1, 699, 1650640654586);
INSERT INTO `orders` VALUES (18, 21650640654586, 2, 1, 1, 1599, 1650640654586);
INSERT INTO `orders` VALUES (19, 11650683523897, 1, 25, 1, 129, 1650683523897);
INSERT INTO `orders` VALUES (20, 11650683523897, 1, 9, 1, 799, 1650683523897);
INSERT INTO `orders` VALUES (21, 11650683523897, 1, 7, 1, 999, 1650683523897);
INSERT INTO `orders` VALUES (22, 11650683523897, 1, 1, 2, 1599, 1650683523897);
INSERT INTO `orders` VALUES (23, 11650683523897, 1, 10, 1, 1899, 1650683523897);
...
CREATE TABLE `product`  (
  ...
  `product_num` int NOT NULL,
  `product_sales` int NULL DEFAULT NULL,
  `product_isPromotion` int NOT NULL COMMENT '用于统计全站的促销商品，用于推荐给用户',
  `product_hot` int NULL DEFAULT NULL COMMENT '用于统计全站购买热度的最多的前几个商品，用于推荐给用户',
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, 'Redmi K30', 1, '120Hz流速屏，全速热爱', '120Hz高帧率流速屏/ 索尼6400万前后六摄 / 6.67\'小孔径全面屏 / 最高可选8GB+256GB大存储 / 高通骁龙730G处理器 / 3D四曲面玻璃机身 / 4500mAh+27W快充 / 多功能NFC', 'public/imgs/phone/Redmi-k30.png', 10000, 1599, 1000, 0, 1, 7);
INSERT INTO `product` VALUES (2, 'Redmi K30 5G', 1, '双模5G,120Hz流速屏', '双模5G / 三路并发 / 高通骁龙765G / 7nm 5G低功耗处理器 / 120Hz高帧率流速屏 / 6.67\'小孔径全面屏 / 索尼6400万前后六摄 / 最高可选8GB+256GB大存储 / 4500mAh+30W快充 / 3D四曲面玻璃机身 / 多功能NFC', 'public/imgs/phone/Redmi-k30-5G.png', 2599, 2599, 100, 0, 0, 0);
INSERT INTO `product` VALUES (3, '小米CC9 Pro', 1, '1亿像素,五摄四闪', '1亿像素主摄 / 全场景五摄像头 / 四闪光灯 / 3200万自拍 / 10 倍混合光学变焦，50倍数字变焦 / 5260mAh ⼤电量 / 标配 30W疾速快充 / ⼩米⾸款超薄屏下指纹 / 德国莱茵低蓝光认证 / 多功能NFC / 红外万能遥控 / 1216超线性扬声器', 'public/imgs/phone/Mi-CC9.png', 2799, 2599, 100, 0, 1, 2);
INSERT INTO `product` VALUES (4, 'Redmi 8', 1, '5000mAh超长续航', '5000mAh超长续航 / 高通骁龙439八核处理器 / 4GB+64GB', 'public/imgs/phone/Redmi-8.png', 799, 699, 100, 0, 1, 4);
INSERT INTO `product` VALUES (5, 'Redmi 8A', 1, '5000mAh超长续航', '5000mAh超长续航 / 高通骁龙439八核处理器 / 4GB+64GB / 1200万AI后置相机', 'public/imgs/phone/Redmi-8A.png', 599, 699, 100, 0, 1, 0);
INSERT INTO `product` VALUES (6, 'Redmi Note8 Pro', 1, '6400万全场景四摄', '6400万四摄小金刚拍照新旗舰超强解析力，超震撼', 'public/imgs/phone/Redmi-Note8-pro.png', 1399, 1199, 100, 0, 1, 2);
INSERT INTO `product` VALUES (7, 'Redmi Note8', 1, '千元4800万四摄', '千元4800万四摄 | 高通骁龙665 | 小金刚品质保证', 'public/imgs/phone/Redmi-Note8.png', 999, 999, 100, 0, 0, 1);
INSERT INTO `product` VALUES (8, 'Redmi 7A', 1, '小巧大电量 持久流畅', '小巧大电量，持久又流畅骁龙8核高性能处理器 | 4000mAh超长续航 | AI人脸解锁 | 整机防泼溅', 'public/imgs/phone/Redmi-7A.png', 599, 539, 100, 0, 1, 2);
INSERT INTO `product` VALUES (9, '小米电视4A 32英寸', 2, '人工智能系统，高清液晶屏', '小米电视4A 32英寸 | 64位四核处理器 | 1GB+4GB大内存 | 人工智能系统', 'public/imgs/appliance/MiTv-4A-32.png', 799, 799, 100, 0, 0, 91);
INSERT INTO `product` VALUES (10, '小米全面屏电视E55A', 2, '全面屏设计，人工智能语音', '全面屏设计 | 内置小爱同学 | 4K + HDR | 杜比DTS | PatchWall | 海量内容 | 2GB + 8GB大存储 | 64位四核处理器', 'public/imgs/appliance/MiTv-E55A.png', 2099, 1899, 100, 0, 1, 18);
INSERT INTO `product` VALUES (11, '小米全面屏电视E65A', 2, '全面屏设计，人工智能语音', '人工智能语音系统 | 海量影视内容 | 4K 超高清屏 | 杜比音效 | 64位四核处理器 | 2GB + 8GB大存储', 'public/imgs/appliance/MiTv-E65A.png', 3999, 2799, 100, 0, 1, 2);
INSERT INTO `product` VALUES (12, '小米电视4X 43英寸', 2, 'FHD全高清屏，人工智能语音', '人工智能语音系统 | FHD全高清屏 | 64位四核处理器 | 海量片源 | 1GB+8GB大内存 | 钢琴烤漆', 'public/imgs/appliance/MiTv-4X-43.png', 1499, 1299, 100, 0, 1, 1);
INSERT INTO `product` VALUES (13, '小米电视4C 55英寸', 2, '4K HDR，人工智能系统', '人工智能 | 大内存 | 杜比音效 | 超窄边 | 4K HDR | 海量片源 | 纤薄机身| 钢琴烤漆', 'public/imgs/appliance/MiTv-4C-55.png', 1999, 1799, 100, 0, 1, 5);
INSERT INTO `product` VALUES (14, '小米电视4A 65英寸', 2, '4K HDR，人工智能系统', '人工智能 | 大内存 | 杜比音效 | 超窄边 | 4K HDR | 海量片源 | 纤薄机身| 钢琴烤漆', 'public/imgs/appliance/MiTv-4A-65.png', 2999, 2799, 100, 0, 1, 4);
INSERT INTO `product` VALUES (15, '小米壁画电视 65英寸', 2, '壁画外观，全面屏，远场语音', '纯平背板 | 通体13.9mm | 远场语音 | 4K+HDR | 杜比+DTS | 画框模式 | 内置小爱同学 | PatchWall | SoundBar+低音炮 | 四核处理器+大存储', 'public/imgs/appliance/MiTv-ArtTv-65.png', 6999, 6999, 100, 0, 0, 3);
INSERT INTO `product` VALUES (16, '米家互联网空调C1（一级能效）', 3, '变频节能省电，自清洁', '一级能效 | 1.5匹 | 全直流变频 | 高效制冷/热 | 静音设计 | 自清洁 | 全屋互联', 'public/imgs/appliance/AirCondition-V1C1.png', 2699, 2599, 10, 10, 1, 5);
INSERT INTO `product` VALUES (17, '米家空调', 3, '出众静音，快速制冷热', '大1匹 | 三级能效 | 静音 | 快速制冷热 | 广角送风 | 除湿功能 | 高密度过滤网 | 典雅外观', 'public/imgs/appliance/AirCondition-F3W1.png', 1799, 1699, 100, 8, 1, 8);
INSERT INTO `product` VALUES (18, '米家互联网洗烘一体机 Pro 10kg', 4, '智能洗烘，省心省力', '国标双A+级洗烘能力 / 22种洗烘模式 / 智能投放洗涤剂 / 支持小爱同学语音遥控 / 支持OTA在线智能升级 / 智能空气洗 / 除菌率达99.9%+', 'public/imgs/appliance/Washer-Pro-10.png', 2999, 2999, 100, 7, 0, 6);
INSERT INTO `product` VALUES (19, 'Redmi K20/ K20 Pro 怪力魔王保护壳', 5, '怪力魔王专属定制', '优选PC材料，强韧张力，经久耐用 / 精选开孔，全面贴合机身 / 手感轻薄细腻，舒适无负担 / 三款颜色可选，彰显个性，与众不同', 'public/imgs/accessory/protectingShell-RedMi-K20&pro.png', 39, 39, 100, 10, 0, 5);
INSERT INTO `product` VALUES (20, '小米9 ARE U OK保护壳', 5, '一个与众不同的保护壳', '彰显独特个性 / 轻薄无负担 / 优选PC材料 / 贴合机身 / 潮流五色', 'public/imgs/accessory/protectingShell-Mi-9.png', 49, 39, 100, 10, 0, 0);
INSERT INTO `product` VALUES (21, '小米CC9&小米CC9美图定制版 标准高透贴膜', 6, '高清透亮，耐磨性强', '耐磨性强，防护更出众 / 疏油疏水，有效抗水抗脏污 / 高清透亮，保留了原生屏幕的亮丽颜色和清晰度 / 操作灵敏，智能吸附 / 进口高端PET材质，裸机般手感', 'public/imgs/accessory/protectingMen-Mi-CC9.png', 19, 19, 100, 9, 0, 0);
INSERT INTO `product` VALUES (22, '小米CC9e 标准高透贴膜', 6, '高清透亮，耐磨性强', '耐磨性强，防护更出众 / 疏油疏水，有效抗水抗脏污 / 高清透亮，保留了原生屏幕的亮丽颜色和清晰度 / 操作灵敏，智能吸附 / 进口高端PET材质，裸机般手感', 'public/imgs/accessory/protectingMen-Mi-CC9e.png', 19, 19, 100, 9, 0, 1);
INSERT INTO `product` VALUES (23, '小米USB充电器30W快充版（1A1C）', 7, '多一种接口，多一种选择', '双口输出 / 30W 输出 / 可折叠插脚 / 小巧便携', 'public/imgs/accessory/charger-30w.png', 59, 59, 100, 8, 0, 1);
INSERT INTO `product` VALUES (24, '小米USB充电器快充版（18W）', 7, '安卓、苹果设备均可使用', '支持QC3.0设备充电 / 支持iOS设备充电/ 美观耐用', 'public/imgs/accessory/charger-18w.png', 29, 29, 100, 8, 0, 0);
INSERT INTO `product` VALUES (25, '小米USB充电器60W快充版（6口）', 7, '6口输出，USB-C输出接口', '6口输出 / USB-C输出接口 / 支持QC3.0快充协议 / 总输出功率60W', 'public/imgs/accessory/charger-60w.png', 129, 129, 100, 0, 0, 46);
INSERT INTO `product` VALUES (26, '小米USB充电器36W快充版（2口）', 7, '6多重安全保护，小巧便携', '双USB输出接口 / 支持QC3.0快充协议 / 多重安全保护 / 小巧便携', 'public/imgs/accessory/charger-36w.png', 59, 59, 100, 0, 0, 0);
INSERT INTO `product` VALUES (27, '小米车载充电器快充版', 7, '让爱车成为移动充电站', 'QC3.0 双口输出 / 智能温度控制 / 5重安全保护 / 兼容iOS&Android设备', 'public/imgs/accessory/charger-car.png', 69, 69, 100, 0, 0, 0);
INSERT INTO `product` VALUES (28, '小米车载充电器快充版(37W)', 7, '双口快充，车载充电更安全', '单口27W 快充 / 双口输出 / 多重安全保护', 'public/imgs/accessory/charger-car-37w.png', 49, 49, 100, 0, 0, 0);
INSERT INTO `product` VALUES (29, '小米二合一移动电源（充电器）', 7, '一个设备多种用途', '5000mAh充沛电量 / 多协议快充 / USB 口输出', 'public/imgs/accessory/charger-tio.png', 99, 99, 100, 0, 0, 0);
INSERT INTO `product` VALUES (30, '小米无线充电宝青春版10000mAh', 8, '能量满满，无线有线都能充', '10000mAh大容量 / 支持边充边放 / 有线无线都能充 / 双向快充', 'public/imgs/accessory/charger-10000mAh.png', 129, 129, 100, 8, 0, 1);
INSERT INTO `product` VALUES (31, '小米CC9 Pro/尊享版 撞色飘带保护壳', 5, '全面贴合，无感更舒适', '优选环保PC材质，强韧张力，全面贴合，无感更舒适', 'public/imgs/accessory/protectingShell-Mi-CC9Pro.png', 69, 69, 100, 0, 0, 2);
INSERT INTO `product` VALUES (32, 'Redmi K20系列 幻境之心保护壳', 5, '柔软坚韧,全面贴合', '优质环保材质，柔软坚韧 / 全面贴合，有效抵抗灰尘 / 鲜亮三种颜色可选，为爱机随时换装', 'public/imgs/accessory/protectingShell-RedMi-K20.png', 39, 39, 100, 0, 0, 0);
INSERT INTO `product` VALUES (33, '小米9 SE 街头风保护壳黑色', 5, '个性时尚,细节出众', '个性时尚 / 细节出众 / 纤薄轻巧 / 多彩时尚', 'public/imgs/accessory/protectingShell-Mi-9SE.png', 49, 49, 100, 0, 0, 0);
INSERT INTO `product` VALUES (34, '小米9 街头风保护壳 红色', 5, '个性时尚,细节出众', '时尚多彩 / 细节出众 / 纤薄轻巧 / 是腕带也是支架', 'public/imgs/accessory/protectingShell-Mi-9-red.png', 49, 49, 100, 0, 0, 0);
INSERT INTO `product` VALUES (35, '小米MIX 3 极简保护壳蓝色', 5, '时尚简约设计，手感细腻顺滑', '时尚简约设计，手感细腻顺滑 / 优质环保PC原材料，强韧张力，经久耐用 / 超薄 0.8MM厚度', 'public/imgs/accessory/protectingShell-Mix-3.png', 49, 12.9, 100, 0, 1, 2);
INSERT INTO `product` VALUES (36, '巨省电 | 小米新1级立式空调', 3, '3匹/变频/新一级能效', '温湿双控/自动清洁/静音设计/立体送风/全屋互联', 'public/imgs/appliance/AirCondition-A1X2.png', 5299, 5299, 100, 0, 0, 3);
INSERT INTO `product` VALUES (42, 'test', 1, 'test', 'test', 'public/imgs/appliance/MiTv-ArtTv-65.png', 1, 1, 1, NULL, 0, NULL);
...
INSERT INTO `product_picture` VALUES (111, 36, 'public/imgs/phone/picture/AirCondition-A1X2.png', NULL);
...
-- ----------------------------
INSERT INTO `shoppingcart` VALUES (132, 1, 16, 3);
INSERT INTO `shoppingcart` VALUES (133, 1, 36, 1);
...
CREATE TABLE `sysmanager`  (
  ...
  `sysname` char(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `syspassword` char(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `userPhoneNumber` char(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`sys_id`) USING BTREE,
  UNIQUE INDEX `sysname`(`sysname`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sysmanager
-- ----------------------------
INSERT INTO `sysmanager` VALUES (1, 'zheng', 'admin123', '15986153182');
...
CREATE TABLE `users`  (
  ...
  `userName` char(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'zheng', 'admin123', '15986153182');
INSERT INTO `users` VALUES (2, 'zzzzzz', 'z123456', '15986153182');
INSERT INTO `users` VALUES (3, 'test1', 'test1', '15986153182');
INSERT INTO `users` VALUES (4, 'test2', 'test2', '15986153182');
INSERT INTO `users` VALUES (5, 'test3', 'test3', '15986153182');
INSERT INTO `users` VALUES (6, 'test4', 'test4', '15986153182');
INSERT INTO `users` VALUES (7, 'test5', 'test5', '15986153182');
INSERT INTO `users` VALUES (8, 'test6', 'test6', '15986153182');
INSERT INTO `users` VALUES (9, 'test7', 'test7', '15986153182');
INSERT INTO `users` VALUES (10, 'test8', 'test8', '15986153182');
