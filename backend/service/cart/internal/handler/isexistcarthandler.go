...
func IsExistCartHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IsExistCartReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewIsExistCartLogic(r.Context(), svcCtx)
		resp, err := l.IsExistCart(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
