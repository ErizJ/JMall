...
func GetUserPaymentsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetUserPaymentsReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewGetUserPaymentsLogic(r.Context(), svcCtx)
		resp, err := l.GetUserPayments(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
