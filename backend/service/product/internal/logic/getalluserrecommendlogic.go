...
type GetAllUserRecommendLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewGetAllUserRecommendLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetAllUserRecommendLogic {
	return &GetAllUserRecommendLogic{
...
func (l *GetAllUserRecommendLogic) GetAllUserRecommend() (resp *types.GetAllProductResp, err error) {
