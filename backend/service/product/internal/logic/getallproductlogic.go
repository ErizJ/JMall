...
func (l *GetAllProductLogic) GetAllProduct() (resp *types.GetAllProductResp, err error) {
	const cacheKey = "jmall:products:all"
	...
	products, queryErr := l.svcCtx.ProductModel.FindAll(l.ctx)
	if queryErr != nil {
		return nil, queryErr
	}
