...
func IsManagerHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IsManagerReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewIsManagerLogic(r.Context(), svcCtx)
		resp, err := l.IsManager(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
