...
import (
	...
	"github.com/ErizJ/JMall/backend/service/user/internal/config"
	"github.com/ErizJ/JMall/backend/service/user/internal/middleware"
...
type ServiceContext struct {
	...
	SysManagerModel model.SysmanagerModel
}
...
func NewServiceContext(c config.Config) *ServiceContext {
	...
	return &ServiceContext{
		...
		SysManagerModel: model.NewSysmanagerModel(conn),
	}
}
